...
describe Pact::Consumer::MockService do
  ...
  context "when a response has been mocked" do
    context "when the actual request is an OPTIONS prior to the actual request" do
      it "returns a 200 to allow the request" do | example |
        ...
        # Needs to check, when you make the actual post, that the CORS is actually set
